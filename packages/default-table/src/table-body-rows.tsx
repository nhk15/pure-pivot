...
export class TableBodyRows<D> extends React.Component<TableBodyRowsProps<D>, never> {
    ...
    render() {
        return this.props.tableDescription.bodyRows.map((row, index) =>
            <this.props.tableBodyRowComponent key={index} row={{ ...row, selected: !!this.props.tableDescription.bodySelectedRow && this.props.tableDescription.bodySelectedRow.index === index }}>
